...
var userDataFormm = document.querySelector('.form-user-data');
...
if (userDataFormm) userDataFormm.addEventListener('submit', function (e) {
  e.preventDefault();
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "11163" + '/');
